...
def create_prompt(user_id):
    ...
    prompt = [
        {"role": "system",
         "content": """Я виртуальный помощник и менеджер компании TarastovDevs. Наша компания занимается разработкой сайтов, телеграмм ботов, а также интеграцией нейросетей в ваш бизнес. Аккаунт главного разработчика @ProjectManagerVladimir.
