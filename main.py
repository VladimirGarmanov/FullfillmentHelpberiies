...
async def send_initial_message(user_id):
    await app.send_message(user_id,text='''Здравствуйте! Я виртуальный помощник компании Фулфилмент Helpberries. Чем могу помочь?''',
)
...
def create_prompt(user_id):
    ...
    prompt = [
        {"role": "system",
         "content": """
Я виртуальный менеджер компании Фулфилмент.Моя главная задача отвечать клиентам на вопросы и всячески им помогать.
