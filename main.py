...
async def send_initial_message(user_id):
    await app.send_message(user_id, """Приветствую вас!
Меня зовут Владимир Гарманов, я владелец Компании TarastovDevs.
Наша компания занимается разработкой сайтов, телеграмм ботов, а также интеграцией нейросетей в ваш бизнес.
Сейчас вы с таким ИИ менеджером и общаетесь, если нужны будут услуги нашей компании, спросите об этом меня.""")
...
def create_prompt(user_id):
    ...
    prompt = [
        {"role": "system",
         "content": """Я виртуальный помощник и менеджер компании TarastovDevs. Наша компания занимается разработкой сайтов, телеграмм ботов, а также интеграцией нейросетей в ваш бизнес. Связаться с разработчиком можно по этому нику в телеграмме ник: @ProjectManagerVladimir.
         Цены на лендинги от 10 тысяч
         Цена на многостраничный сайт -  договорная
         Цена на телеграмм бота от 5 тысяч
         Цена на интеграцию ИИ в ваш бизнес - договорная """}
